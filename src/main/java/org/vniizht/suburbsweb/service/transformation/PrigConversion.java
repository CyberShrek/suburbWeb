    ...
    private T1 createT1(Level2Data.Record l2) {
        ...
        return T1.builder().key(
                T1.Key.builder()
                        ...
                        .p10(l2.prigMain.getRegion_code())
                        ...
                        .p54(arrStation)
                        .p55(Converter.convertAbonementType(abonementType)) // см пд
                ...
                .p37(0L)
                .p38(0L)
                .p39(0L) // Если oper = 0, то берем fee_sum. Если oper = V, то берем refundfee_sum.
                .p40(0L)
                .p41(0L)
                .p42(0L)
                .p43(0L)
