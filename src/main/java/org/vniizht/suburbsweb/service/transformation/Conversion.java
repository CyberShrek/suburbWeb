...
//        logger.log("\t\tprig_co22_t1");
        ...
        return T1.builder()
                ...
                .p58(Converter.convert58(l2.main.getBenefitgroup_code(), l2.adi.getBilgroup_code()))
                .p59(Converter.convert59(l2.main.getBenefitgroup_code(), l2.adi.getEmployee_cat()))
                .p60("000")
